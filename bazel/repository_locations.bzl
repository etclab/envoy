...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_etclab_kube_c_client = dict(
        project_name = "etclab-kube-c",
        project_desc = "Official C client library for Kubernetes",
        project_url = "https://github.com/etclab/kube-c-client",
        version = "8c63dfafb51efaf65e576a64568731b39beda98c",
        sha256 = "ef9e7ed41dbb1ed650c970c738ea5c776ef98fd83f249f05a38eabd14211663b",
        strip_prefix = "kube-c-client-{version}",
        urls = ["https://github.com/etclab/kube-c-client/archive/{version}.tar.gz"],
        use_category = ["other"],
        extensions = ["envoy.tls.cert_validator.rbe"],
        release_date = "2025-01-06",
        cpe = "N/A",
        license = "Apache-2.0",
        license_url = "https://github.com/etclab/kube-c-client/blob/{version}/LICENSE",
    ),
    com_github_warmcat_libwebsockets = dict(
        project_name = "libwebsockets",
        project_desc = "Libwebsockets (LWS) is a flexible, lightweight pure C library for implementing modern network protocols easily with a tiny footprint, using a nonblocking event loop.",
        project_url = "https://libwebsockets.org/",
        version = "e0c312c20248b2c7f509216e3b3463dc372fc114",
        sha256 = "89055e6014af961e058a5a7cb9609ea949e2813e070fcf6392c150ddb12ce2d4",
        urls = ["https://github.com/warmcat/libwebsockets/archive/{version}.tar.gz"],
        strip_prefix = "libwebsockets-{version}",
        use_category = ["other"],
        extensions = ["envoy.tls.cert_validator.rbe"],
        release_date = "2023-11-20",
        cpe = "N/A",
        license = "libwebsockets",
        license_url = "https://github.com/warmcat/libwebsockets/blob/{version}/LICENSE",
    ),
    com_github_yaml_libyaml = dict(
        project_name = "libyaml",
        project_desc = "LibYAML is a YAML parser and emitter library.",
        project_url = "http://pyyaml.org/wiki/LibYAML",
        version = "840b65c40675e2d06bf40405ad3f12dec7f35923",
        sha256 = "2cbefb0ff048e24a8b9e96130e9e9b3da896263e7fa6e7fb2acd0ecab2bec620",
        urls = ["https://github.com/yaml/libyaml/archive/{version}.tar.gz"],
        ...
        cpe = "N/A",
        license = "MIT",
        license_url = "https://github.com/yaml/libyaml/blob/{version}/License",
    ),
